package edu.uci.ics.khefner.service.idm.Security;

import edu.uci.ics.khefner.service.idm.BasicService;
import edu.uci.ics.khefner.service.idm.configs.Configs;

import java.sql.Timestamp;

public class Session {
    public static final long SESSION_TIMEOUT = BasicService.getConfigs().getTimeout(); // 10-minute timeout
    public static final long TOKEN_EXPR = BasicService.getConfigs().getExpiration(); // 30-minute expiration
