...
public class BasicService {
    ...
    private void connectToDatabase() {
        ...
        String hostName = configs.getDatabaseHostName(); //"localhost";
        ...
        int port = configs.getDatabasePort(); // 3307;
        ...
        String dbName = configs.getDatabaseName(); //"cs122b_example";
        ...
        String settings = configs.getDatabaseSettings(); //"?autoReconnect=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=PST";
    ...
    private void initHTTPServer() {
        ...
        try {
            ...
            ResourceConfig rc = new ResourceConfig().packages("edu.uci.ics.khefner.service.idm.resources");
            //// Set Jackson to be the default serializer
            ServiceLogger.LOGGER.config("Set Jackson as serializer");
            rc.register(JacksonFeature.class);
            // Create the server
            ServiceLogger.LOGGER.config("Creating Http Server");
