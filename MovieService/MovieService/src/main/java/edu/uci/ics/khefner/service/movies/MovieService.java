package edu.uci.ics.khefner.service.movies;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.fasterxml.jackson.dataformat.yaml.YAMLFactory;
import edu.uci.ics.khefner.service.movies.configs.ConfigsModel;
import edu.uci.ics.khefner.service.movies.configs.MovieConfigs;
...
public class MovieService {
    ...
    private void initHTTPServer() {
        ...
        try {
            ...
            ResourceConfig rc = new ResourceConfig().packages("edu.uci.ics.khefner.service.movies.resources");
