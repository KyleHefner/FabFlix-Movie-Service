package edu.uci.ics.khefner.service.api_gateway;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.fasterxml.jackson.dataformat.yaml.YAMLFactory;
import edu.uci.ics.khefner.service.api_gateway.configs.*;
import edu.uci.ics.khefner.service.api_gateway.connectionpool.ConnectionPool;
import edu.uci.ics.khefner.service.api_gateway.configs.*;
import edu.uci.ics.khefner.service.api_gateway.logger.ServiceLogger;
import edu.uci.ics.khefner.service.api_gateway.threadpool.ThreadPool;
...
public class GatewayService {
    ...
    private void initHTTPServer() {
        ...
        try {
            ...
            ResourceConfig rc = new ResourceConfig().packages("edu.uci.ics.khefner.service.api_gateway.resources");
