package edu.uci.ics.khefner.service.api_gateway.connectionpool;
...
public class ConnectionPool {
    ...
    public Connection requestCon() {return connections.isEmpty() ? createConnection() : connections.removeFirst(); }

    public void releaseCon(Connection con) { connections.add(con); }
